...
const passport = require('./OAuth/conf.Login');//canvip add a OAuth/conf.Login'fix error login url
...
app.get('/mongodb', function(req, res) {
  ...
  //const dom = new JSDOM(`<!DOCTYPE html><p>Hello from mongodb</p>`);
    ...
    //var url = 'mongodb://104.199.213.214:28017/wazzayferdb';
    res.write('attempting connection to db<br/>');
    var url = '';
  
  let uri = 'mongodb://35.194.202.205:8888/wazzayferdb';
  ...
  console.log(url);
    ...
    MongoClient.connect(url, function(err, db) {
        if(db!=null)
        {
        res.write('listing available db...<br/>');
        ...
        else res.write('error: connection to db failed<br/>');
        res.write('done');
        res.end();
    });
